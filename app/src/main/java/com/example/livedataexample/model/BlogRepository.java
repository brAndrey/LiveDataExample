...
import com.example.livedataexample.service.RetrofitInstance;
...
public class BlogRepository {
    ...
    public  BlogRepository(Application application){this.application = application;}


    public MutableLiveData<List<Blog>> getMutableLiveData(){

        RestApiService apiService = RetrofitInstance.getApiServer();
